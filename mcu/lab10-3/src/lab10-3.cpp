...
static void task1(void *pvParameters) {
        ...
        while (1) {
                // Reading one character at a time just so we can have backspace
                // functioning correctly in the terminal
                // Default behavior just moves cursor back
                // We can replace the previous character with empty character
